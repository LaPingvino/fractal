...
use crate::{
    ...
    session_view::content::room_history::member_timestamp::{
...
mod imp {
    ...
    #[template(
        resource = "/org/gnome/Fractal/ui/session_view/content/room_history/read_receipts_list/read_receipts_popover.ui"
    )]
